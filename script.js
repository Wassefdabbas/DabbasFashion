...
const translations = {
  ...
  ar: {
    ...
    about_head_t: "دباس فاشن",
    about_head: "من دمشق إلى العالم",
    about_p1: "تمثل دباس فاشن قمة الحرفية في الزفاف. كل طرحة تروي قصة من التقاليد، منسوجة بجماليات حديثة لخلق قطعة خالدة بحق.",
