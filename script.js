...
const translations = {
  en: {
    ...
    acc_sub: "Details",
    acc_title: "Bridal Accessories", acc_col: "In collaboration with - AFADAR Accessories -",
    acc_1: "Hair Comb", acc_2: "Hair Vine", acc_3: "Bridal Crown", acc_4: "Hair Pin",
  ...
  ar: {
    ...
    about_head_t: "دباس فاشين",
    about_head: "من دمشق إلى العالم",
    about_p1: "تمثل دباس فاشين قمة الحرفية في الزفاف. كل طرحة تروي قصة من التقاليد، منسوجة بجماليات حديثة لخلق قطعة خالدة بحق.",
    ...
    acc_sub: "تفاصيل",
    acc_title: "إكسسوارات الزفاف", acc_col: "بالتعاون مع - إكسسوارات أفادار -",
    acc_1: "مشط شعر", acc_2: "زينة شعر", acc_3: "تاج زفاف", acc_4: "دبوس شعر",
    cont_title: "ابدئي رحلتك", cont_btn: "إرسال عبر واتساب",
    why_title: "لماذا دباس فاشين ",
